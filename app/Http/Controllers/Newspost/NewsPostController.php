...
class NewsPostController extends Controller
{
    ...
    public function create(Request $request){
        ...
        $image_url = 'http://127.0.0.1:8000/uploads/' .$filename;
            ...
            //$image_url = 'http://dda930e2.ngrok.io/uploads/noimage.jpg';
            ...
            if($old_news_feed instanceof NewsPost) {
                ...
                if ($image_file) {
                    ...
                    if($file_extension == "jpg" || $file_extension == "png") {
                        ...
                        $image_url = 'http://dda930e2.ngrok.io/uploads/' . $posted_file_name;
                    } else {
                        $image_url = 'http://dda930e2.ngrok.io/uploads/noimage.jpg' . $posted_file_name;
                    }
                }
